...
const initialMovies: Movie[] = [
  {
    ...
    summary:
      "Harry, Ron, and Hermione prepare for the final battle against Lord Voldemort",
    genres: ["Action", "Drama"],
    imageUrl:
  ...
  },
  {
    ...
    summary:
      "An adventurous Polynesian teenager sets sail on a daring journey to save her island",
  ...
  },
  {
    ...
    director: "Various",
    summary:
      "English Movies: Watch English Movies 2021, Latest Hollywood Movies Online ",
    genres: ["Action"],
    imageUrl:
  ...
  },
  {
    ...
    summary:
      "Welcome to The Jungle (English) Movie: Review | Release Date | Songs | Music",
    genres: ["Action"],
    imageUrl:
